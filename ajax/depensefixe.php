...
/**
 *       \file       htdocs/tresoreriemensuelle/ajax/depensefixe.php
 *       \brief      File to return Ajax response on depensefixe list request
 */
...
// Security check
if (!$user->hasRight('tresoreriemensuelle', 'depensefixe', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax tresoreriemensuelle/ajax/depensefixe.php");
